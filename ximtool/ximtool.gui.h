...
"    *printcmd.translations:     \\",
"      <Key>Delete:    delete-previous-character() select-start() select-end()\\n\\",
"      <Key>BackSpace: delete-previous-character() select-start() select-end()\\n\\",
"      <Key>: delete-selection() insert-char() select-start() select-end() \\n\\",
...
"        5 \\",
"    }",
"    *helpInfo1.label:            XImtool V1.0   --   Released: 3/6/97",
...
"# Start up the GUI.",
"createObjects",
"send colorbar setGterm",
"send imagewin setGterm",
"activate",
"",
...
"",
"# Global variables.",
"set version	\"NOAO/IRAF XImtool Version 1.0 - BETA TEST VERSION\"",
"",
"set winWidth 512		;# display window width",
"set winHeight 512		;# display window height",
...
"			    setPrintCorners $x0 $y0 \\",
"				[expr $x0 + $nx -1] [expr $y0 + $ny -1]",
...
"    global displayPanner displayCoords",
...
"    }",
"    setPrintCorners 0 0 [expr $winWidth - 1] [expr $winHeight - 1]",
"",
"    send client print",
"    send imagewin setCursorType idle",
...
"    global winWidth winHeight",
"",
"    # Convert raw corner screen coordinates to frame buffer raster coordinates.",
...
"",
"    send client setPrintOption corners $llx $lly $urx $ury",
"}",
"",
"",
"#--------------------------",
...
"                          }",
"        	tiff      { send svRGBButton setSensitive true",
"                            send svPseudoButton setSensitive true",
